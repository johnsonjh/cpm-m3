 ...
 *
 *	2013-06-16 rli: host variant for dim; suck up gnu packing.
 *
 ************************************************************************/
 ...
 * __attribute__
 *
 *	This declaration deletes the GNU packed attribute. Since we're not loading
 *	programs as a host tool, we don't need to have our structures packed to meet
 *	the description given in the CP/M-68K documentation.
 *
 * revisions:
 *
...
#define config_archtag_c 0x6c6c7563 /* "null" */
...
#define config_banner_c "(disk image manipulator)"
 ...
 *
 *	2013-06-16 rli: enabled for dim.
 *
 ***/
 ...
 *	BDOS, traphndl, calls platform_traphndl isntead of doing
 *	nothing.
 *
 * revisions:
 *
