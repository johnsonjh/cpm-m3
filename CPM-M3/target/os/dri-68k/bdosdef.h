 ...
 * revisions:
 *
 *	2010-08-22 rli: added another dummy word to the DPH for
 *	  alignment reasons.
 *
 *	2010-08-24 rli: decided to pack the DPH instead of adding
 *	  a word; it is publically visible, after all.
 *
 *	2013-04-25 rli: visual c packing instead of gnu c
 *
 *	2013-04-29 rli: back to gnu c packing, omission of array size
 *	  in conbuf struct.
 *
 *	2013-04-29 rli: the 17-Mar-84 change created a global variable
 *	  named chainp that resides in every module that includes this
 *	  header. marked it extern here and we'll have to find it a
 *	  home somewhere. huh; turns it it already has a home in ccp.c.
 *
 ***/
