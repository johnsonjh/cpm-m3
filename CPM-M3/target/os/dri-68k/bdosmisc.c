 ...
 * revisions:
 *
 *	2010-08-07 rli: typecasts and a bit of fiddling with structure
 *	  declarations.
 *
 *	2010-08-22 rli: pack the MRT in bdosinit() and the structure
 *	  used by set_tpa.
 *
 *	2013-04-25 rli: visual c packing instead of gnu c. ensure error
 *	  returns a value to keep the compiler happy.
 *
 *	2013-04-29 rli: back to gnu c packing.
 *
 *	2013-06-05 rli: include config.h and provide an opportunity to
 *	  override the default trap2 vector number.
 *
 ***/
...
#ifdef config_trap2v_c
#define trap2v config_trap2v_c
#else
