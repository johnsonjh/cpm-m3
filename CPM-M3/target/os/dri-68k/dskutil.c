 ...
 * revisions:
 *
 *	2010-08-07 rli: buncha typecasts and drop a comparison that the
 *	  compiler complained is always true.
 *
 *	2013-06-07 rli: include config.h so the host tools can #define
 *	  away the gcc packing attributes.
 *
 ***/
