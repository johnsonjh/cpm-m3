 ...
 * revisions:
 *
 *	2010-08-20 rli: Don't define HILO; we'll do it in the Makefile
 *	  if we need it. It needs to be defined for bigendian machines.
 *
 *	  filler byte in dpb was commented out; that's not the case in
 *	  the CP/M-68K BDOS.
 *
 ***/
