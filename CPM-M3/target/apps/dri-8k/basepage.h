 ...
 * revisions:
 *
 *	2010-08-20 rli: added external declaration of pointer to
 *	  basepage. I'm not sure how this was handled when compiling
 *	  under CP/M-8K, since I don't see it in any of the headers.
 *
 *****/
