 ...
 *
 *	- entry: A pointer to the program entry point. This is normally
 *	  tpabase+0x200.
 *
 *	  CP/M-68K and CP/M-8K don't have this field.
 *
 ...
 *	- textbase: Receives tpabase+0x200.
 *	- textlen: Receives the length, in bytes, of the executable
 *	  file.
 *	- database: Receives textbase+textlen.
 *	- datalen: Receives zero.
 *	- bssbase: Receives textbase+textlen.
 ...
 *	  to load the image.
 *
 *	- version: I don't really have plans for this, but I thought it
 *	  might be nice if the header were 16 bytes long instead of 12.
 *
 ***/
